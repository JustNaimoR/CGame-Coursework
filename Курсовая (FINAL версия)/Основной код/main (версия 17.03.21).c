...
//TODO - Добавить возможность восстановить стандартные клавиши управления
int main() {
...
void Option_Help() {
    ...
    int width_of_console;  //  Ширина консоли
    int height_of_console;  //  Высота консоли
...
void Choiced_help_option(int option) {
    ...
    if (option == 0) {  //  Опция 'Стереть рекорды'
        //TODO  Реализовать функцию стирания рекордов
        Choiced_option(5, "NOT DONE YET!!!");
