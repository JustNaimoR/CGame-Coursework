...
void Game(int difficulty, unsigned char* first_word);
//  ============================================  Префиксное дерево  ===================================================
...
void Pre_Game(Difficulty_level difficulty) {
    ...
    //TODO  создать дерево-словарь из папок пользователя и основного словаря

    unsigned char* first_word = First_word_Output();  //  Требование ввести первое слово и вывод меню
    //  >>  Получено первое слово игры

    Game(difficulty, first_word);
}
