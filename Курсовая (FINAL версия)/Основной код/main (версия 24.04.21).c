...
unsigned char* COMP_COMPStep(unsigned char playing_field[5][5], Difficulty_level difficult);
...
int main() {
    ...
    //  Открываем словари
    //  C:\Users\Romario\Desktop\VOC.txt
    FILE* Main_dictionary = fopen("C:\\Users\\Romario\\Desktop\\VOC.txt", "r");  //  Стандартный словарь игры
    ...
    unsigned char pole[5][5] = { { 0,227,224,0,224 }, { 0,247,226,224,235 }, { 245,0,242,227,0 }, { 224,0,238,254,0 }, { 239,0,240,235,0 } };

    unsigned char string_2[] = { 224, 226, 242, 238, 240, 0 };
    ...
    //Game_AddWordInList((unsigned char*) "абажур");

    for (int i = 0; i < 5; i++) {
        unsigned char* word = COMP_COMPStep(pole, HARD);
        printf("Выбрана  %s\n", word);
        Game_AddWordInList(word);
    }
    return 0;
...
unsigned char* COMP_COMPStep(unsigned char playing_field[5][5], Difficulty_level difficult) {
    ...
    for (int current_word = 0; words[current_word][0] != 0; current_word++) {
        ...
        if (Game_RepeatCheck(words[current_word])) {
     ...
     *    45%  -  X == 4      17%  -  X == 4       10%  -  X == 4
     *    30%  -  X == 5      50%  -  X == 5|6     30%  -  X == 5|6|7
     *    5%   -  X == 6      20%  -  X == 7|8     25%  -  X == 8|9|10
     *                        5%   -  X == 9       20%  -  X == 11
     *                                             10%  -  X >= 12
     * */
    ...
    if (difficult == EASY) {  //  Выбрана сложность "легко"
        ...
        while (1) {  //  Цикл для случаев выпадения пустого диапазона
            //  Просмотр выпавшего числа
            if (Main_Data.Random % 100 < 8 && koll[2] + koll[3] != 0) {  //  8%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
                ...
                return words[last_mark];
            } else if (Main_Data.Random % 100 >= 8 && Main_Data.Random % 100 < 25 && koll[4] != 0) {  //  17%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
                ...
                return words[last_mark];
            } else if (Main_Data.Random % 100 >= 25 && Main_Data.Random % 100 < 75 && koll[5] + koll[6] != 0) {  //  50%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
                ...
                return words[last_mark];
            } else if (Main_Data.Random % 100 >= 75 && Main_Data.Random % 100 < 95 && koll[7] + koll[8] != 0) {  //  20%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
        ...
        while (1) {  //  Цикл для случаев выпадения пустого диапазона
            ...
            if (Main_Data.Random % 100 < 5 && koll[2] + koll[3] != 0) {  //  5%
                ...
                return words[last_mark];
            } else if (Main_Data.Random % 100 >= 5 && Main_Data.Random % 100 < 15 && koll[4] != 0) {  //  10%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
                ...
                return words[last_mark];
            } else if (Main_Data.Random % 100 >= 15 && Main_Data.Random % 100 < 45 && koll[5] + koll[6] + koll[7] != 0) {  //  30%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
                ...
                return words[last_mark];
            } else if (Main_Data.Random % 100 >= 45 && Main_Data.Random % 100 < 70 && koll[8] + koll[9] + koll[10] != 0) {  //  25%
                //  Обновляем значение Random
                Main_Data.Random = LKG(Main_Data.Random);
